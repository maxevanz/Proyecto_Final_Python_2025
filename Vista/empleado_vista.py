...
class VistaEmpleado(tk.Frame):
    ...
    def crear_formulario(self):
        ...
        tk.Label(self, text="Administrar Empleados", font=("Arial", 12)).grid(row=0, column=0, padx=5, sticky="nw")
        ...
        self.boton_crear.grid(row=0, column=0, pady=2)
        ...
        self.boton_editar.grid(row=1, column=0, pady=2)
    ...
    def mostrar_grilla(self):
        ...
        columnas = ("Id", "Apellido","Nombre","Correo","Telefono","Estado")
        self.grilla = ttk.Treeview(self, columns=columnas, show="headings", style="Treeview")
